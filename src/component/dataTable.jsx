...
export default function DataTable(
    ...
    const headerKey = headers.map((header) => header);
    ...
    const onChangeSelect = (value) => {
        ...
        updateSelection([...newSelection]);    //updateSelection 함수 호출
    };
    ...
    const onChangeSelectAll = (e) => {
        if (e.target.checked) {
            ...
            updateSelection([...allCheckedSelection]);      //updateSelection 함수호출
        } else {
    ...
    const isSelectedAll = () => {           //전체 선택 상태 여부
